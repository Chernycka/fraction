...
void Fraction::toStrig() {
	if(_a==0){ std::cout << 0<< std::endl; }
	else{
...
{
	int tmp = _a / _b;
	std::cout << tmp << " and" << (_a - _b * tmp) << std::endl;
}
